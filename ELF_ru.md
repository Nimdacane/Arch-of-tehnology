...
| EI_VERSION    |     `0x0006`      |       1        | `0x01`       | Версия ELF(Зарезервировано, пока что существует только 1 версия) |
...
| e_version     |     `0x0014`      |       4        | `0x01`       | Версия ELF(Зарезервировано, пока что существует только 1 версия) |
